...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1597, 880)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(20, 270, 181, 191))
        ...
        self.tabWidget.setGeometry(QtCore.QRect(230, 60, 1341, 771))
        self.tabWidget.setTabBarAutoHide(False)
        self.tabWidget.setObjectName("tabWidget")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.floor_map = PlotWidget(self.tab)
        self.floor_map.setGeometry(QtCore.QRect(10, 10, 1311, 731))
        self.floor_map.setObjectName("floor_map")
        self.tabWidget.addTab(self.tab, "")
        self.tab_2 = QtWidgets.QWidget()
        self.tab_2.setObjectName("tab_2")
        self.groupBox_5 = QtWidgets.QGroupBox(self.tab_2)
        self.groupBox_5.setGeometry(QtCore.QRect(10, 10, 1221, 381))
        self.groupBox_5.setObjectName("groupBox_5")
        self.tags_table = QtWidgets.QTableWidget(self.groupBox_5)
        self.tags_table.setGeometry(QtCore.QRect(10, 20, 1191, 351))
        ...
        self.groupBox_8.setGeometry(QtCore.QRect(10, 400, 1221, 341))
        self.groupBox_8.setObjectName("groupBox_8")
        self.anchors_table = QtWidgets.QTableWidget(self.groupBox_8)
        self.anchors_table.setGeometry(QtCore.QRect(10, 20, 1201, 311))
        ...
        self.anchors_table.setColumnCount(12)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.anchors_table.setHorizontalHeaderItem(11, item)
        self.tabWidget.addTab(self.tab_2, "")
        self.groupBox_9 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_9.setGeometry(QtCore.QRect(30, 460, 161, 181))
        self.groupBox_9.setObjectName("groupBox_9")
        self.verticalLayoutWidget_4 = QtWidgets.QWidget(self.groupBox_9)
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(10, 20, 141, 154))
        ...
        self.y_ref_tag = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.y_ref_tag.setObjectName("y_ref_tag")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.y_ref_tag)
        ...
        self.z_ref_tag = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.z_ref_tag.setObjectName("z_ref_tag")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.z_ref_tag)
        self.ref_tag_checkbox = QtWidgets.QCheckBox(self.verticalLayoutWidget_4)
        self.ref_tag_checkbox.setObjectName("ref_tag_checkbox")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.ref_tag_checkbox)
        self.x_ref_tag = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.x_ref_tag.setObjectName("x_ref_tag")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.x_ref_tag)
        self.ID_ref_tag = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.ID_ref_tag.setObjectName("ID_ref_tag")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.ID_ref_tag)
        ...
        self.update_ref_tag_button = QtWidgets.QPushButton(self.verticalLayoutWidget_4)
        self.update_ref_tag_button.setObjectName("update_ref_tag_button")
        self.verticalLayout_4.addWidget(self.update_ref_tag_button)
        self.verticalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(60, 730, 97, 80))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.log_check_box = QtWidgets.QCheckBox(self.verticalLayoutWidget)
        self.log_check_box.setChecked(False)
        ...
        self.groupBox_10.setGeometry(QtCore.QRect(30, 650, 151, 61))
        self.groupBox_10.setObjectName("groupBox_10")
        self.horizontalLayoutWidget_3 = QtWidgets.QWidget(self.groupBox_10)
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(10, 20, 131, 31))
        self.horizontalLayoutWidget_3.setObjectName("horizontalLayoutWidget_3")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_3)
        self.horizontalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.tag_h0_Edit = QtWidgets.QLineEdit(self.horizontalLayoutWidget_3)
        self.tag_h0_Edit.setObjectName("tag_h0_Edit")
        self.horizontalLayout_4.addWidget(self.tag_h0_Edit)
        self.tag_h0_button = QtWidgets.QPushButton(self.horizontalLayoutWidget_3)
        self.tag_h0_button.setObjectName("tag_h0_button")
        self.horizontalLayout_4.addWidget(self.tag_h0_button)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.anchors_table.horizontalHeaderItem(11)
        item.setText(_translate("MainWindow", "Ref tag correction"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Info"))
        self.groupBox_9.setTitle(_translate("MainWindow", "Reference tag"))
        ...
        self.ref_tag_checkbox.setText(_translate("MainWindow", "Enable"))
        self.label_9.setText(_translate("MainWindow", "ID"))
        self.update_ref_tag_button.setText(_translate("MainWindow", "Update"))
        ...
        self.groupBox_10.setTitle(_translate("MainWindow", "Tags height"))
        self.tag_h0_button.setText(_translate("MainWindow", "Update"))
